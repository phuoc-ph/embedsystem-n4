...
void setup() {
  ...
  airHumiditySensorWorkScheduler = new WorkScheduler(2000UL, onAirSensorWork);
  
  soilHumiditySensorWorkScheduler = new WorkScheduler(2000UL, onSoilSensorWork);
  
  distanceSensorWorkScheduler = new WorkScheduler(2000UL, onDistanceSensorWork);
}
